...
When the user requests a merge, merge the current ordinary PR, pull main, surface any open contributor PRs and untriaged contributor issues, and show open milestone issues.

For release PRs, use the [release procedure](../../.claude/skills/release/SKILL.md)
for merging and tagging; retain the contributor and milestone reporting below.
